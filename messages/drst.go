...
func (d *DestinationRestricted) UnmarshalBinary(b []byte) error {
	*d = DestinationRestricted{}
	var err error
	d.Header, err = parseTypedHeader(b, MsgClassSSNM, MsgTypeDestinationRestricted)
	if err != nil {
		return err
	}
...
// String returns the DestinationRestricted values in human readable format.
func (d *DestinationRestricted) String() string {
	if d == nil {
		return ""
	}
