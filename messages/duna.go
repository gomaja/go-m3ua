...
func (d *DestinationUnavailable) UnmarshalBinary(b []byte) error {
	*d = DestinationUnavailable{}
	var err error
	d.Header, err = parseTypedHeader(b, MsgClassSSNM, MsgTypeDestinationUnavailable)
	if err != nil {
		return err
	}
...
// String returns the DestinationUnavailable values in human readable format.
func (d *DestinationUnavailable) String() string {
	if d == nil {
		return ""
	}
