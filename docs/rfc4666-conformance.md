...
| [1.3.2.1 MTP3-User transport](https://www.rfc-editor.org/rfc/rfc4666.html#section-1.3.2.1) | Mandatory | Partial | DATA transfer and delivery are implemented for ASP, SGP, and IPSP Single Exchange. IPSP Double Exchange depends on [#16](https://github.com/gomaja/go-m3ua/issues/16). |
...
| [1.4.3.4 IPSP considerations](https://www.rfc-editor.org/rfc/rfc4666.html#section-1.4.3.4) | Mandatory when IPSP is used | Partial | `RoleIPSP` requires an explicit Association-level exchange model. Mandatory Single Exchange is implemented; Double Exchange is [#16](https://github.com/gomaja/go-m3ua/issues/16). |
...
| [1.5 Sample configurations](https://www.rfc-editor.org/rfc/rfc4666.html#section-1.5) | Descriptive | Informative | ASP/SGP examples exist, and the IPSP Single Exchange configuration and bidirectional transfer matrix are covered. Double Exchange is #16. |
...
| [4.3.1 ASP/IPSP states](https://www.rfc-editor.org/rfc/rfc4666.html#section-4.3.1) | Mandatory | Partial | ASP state is implemented per Association and per ASKey. IPSP Single Exchange maintains the remote IPSP state and bidirectional AS scope; independent Double Exchange directional state is #16. |
...
| [4.3.4.1 ASP Up](https://www.rfc-editor.org/rfc/rfc4666.html#section-4.3.4.1) | Mandatory | Partial | ASP/SGP and IPSP Single Exchange version, identifier, duplicates, simultaneous messages, retry, timeout, and restart are covered. IPSP Double Exchange is #16. |
| [4.3.4.2 ASP Down](https://www.rfc-editor.org/rfc/rfc4666.html#section-4.3.4.2) | Mandatory | Partial | ASP/SGP and IPSP Single Exchange quiescence, acknowledgement, timeout, restart, and shutdown ordering are covered. IPSP Double Exchange is #16. |
| [4.3.4.3 ASP Active](https://www.rfc-editor.org/rfc/rfc4666.html#section-4.3.4.3) | Mandatory | Partial | ASKey authorization, omitted RC rules, traffic mode, state, retry, acknowledgements, and IPSP Single Exchange bidirectional activation are covered. n+k is #18; IPSP Double Exchange is #16. |
| [4.3.4.4 ASP Inactive](https://www.rfc-editor.org/rfc/rfc4666.html#section-4.3.4.4) | Mandatory | Partial | Scoped inactivity, acknowledgements, and IPSP Single Exchange bidirectional withdrawal are covered. IPSP Double Exchange is #16. |
| [4.3.4.5 Notify](https://www.rfc-editor.org/rfc/rfc4666.html#section-4.3.4.5) | Mandatory | Implemented | ASP/SGP and IPSP Single Exchange Notify handling covers AS state, Other, Alternate ASP Active, ASP Failure, identifier, and Routing Context scope, with Held Errata 2065 explicitly classified. |
...
| [5.6 IPSP examples](https://www.rfc-editor.org/rfc/rfc4666.html#section-5.6) | Descriptive | Partial | The Section 5.6.1 Single Exchange sequence and all independent SCTP, ASPSM, and ASPTM initiator combinations are covered. Double Exchange is #16. |
