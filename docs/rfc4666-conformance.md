...
| [1.3.2.1 MTP3-User transport](https://www.rfc-editor.org/rfc/rfc4666.html#section-1.3.2.1) | Mandatory | Partial | DATA transfer and delivery are implemented for ASP and SGP roles. IPSP transfer depends on [#15](https://github.com/gomaja/go-m3ua/issues/15) and [#16](https://github.com/gomaja/go-m3ua/issues/16). |
